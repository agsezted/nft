{
  ...
  NFT_NAME= "Cryptovers NFT",
  SYMBOL= "CVNFT",
  MAX_SUPPLY= 200000,
  WEI_COST= 0.0125 * 10 ** 18,
  DISPLAY_COST= 0.0125,
  GAS_LIMIT= 285000
}
...
const getContract = async (web3) => {
  const response = await fetch("client/contracts/abi.js");
...
async function loadAccount() {
  ...
  document.getElementById("nft_balance").textContent="You have " + balance + "CRYPTOVERSNFT"
}
      ...
      if (netId == NETWORK_ID) {
        var awaitContract = async function () {
          ...
          if(document.getElementById("price"))
            document.getElementById("price").textContent= "Price: " + web3.utils.fromWei(NFT_PRICE) + " BNB"
          if(document.getElementById("presale_price"))
            document.getElementById("presale_price").textContent= "Presale Price: " + web3.utils.fromWei(PRESALE_PRICE) + " BNB"
        ...
        document.getElementById("web3_message").textContent="Please connect to bsc testnet";
      }
    });
  };
  awaitWeb3();
